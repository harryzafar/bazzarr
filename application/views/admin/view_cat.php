...
<div class="content-wrapper">
          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="<?php echo base_url('admin/categories/add') ?>" class="btn btn-primary"><i
              ...
              <table class="table">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button class="btn btn-danger del btn-sm"  onclick="getid(<?php echo $row['id'] ;?>)"><i
 ...
 <script>
  function getid(id){
    $('#del_btn').attr('href', "<?php echo base_url('admin/categories/delete/') ;?>"+id);
