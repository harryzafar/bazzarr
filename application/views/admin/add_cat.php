      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <form action="<?php echo base_url('admin/categories/create') ?>" method="post" class="categoryForm"
                id="categoryForm" enctype="multipart/form-data">
                <div class="form-group">
                  <label for="cat-name">Name</label>
                  <input type="text" id="cat-name" name="name" value="<?php echo set_value('name'); ?>" class="form-control" placeholder="Category Name">
