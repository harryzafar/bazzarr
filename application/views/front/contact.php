                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="contact-item">
                                    ...
                                    <div class="contact-details">
                                        ...
                                        <a class="contact-info" href="mailto:husain.zafar13@gmail.com">husain.zafar13@gmail.com</a>
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="contact-item">
                                    ...
                                    <div class="contact-details">
                                        ...
                                        <p class="contact-info">Ansar Maidan Ganj muradabad Unnao</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="contact-item">
                                    ...
                                    <div class="contact-details">
                                        ...
                                        <a class="contact-info" href="tel:+918564900906">+91 8546 900906</a>
                                        <a class="contact-info" href="tel:+918299216108">+91 8299 216108</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="contact-form-area">
                        ...
                        <div>
                            <?php if($this->session->flashdata('sent')){;?>
                                ...
                                <strong><?php echo $this->session->flashdata('sent');?>
                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                              </div>
                           <?php } ;?>
                        </div>
                        <div class="contact-form--wrapper">
                            <form action="<?php echo base_url('home/contact');?>" method="post" class="contact-form" id="contact_form">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12">
                                        ...
                                        <button type="submit"
                                              class="position-relative review-submit-btn contact-submit-btn" id="send_btn">SEND
                                              MESSAGE</button>
