                    ...
                    <div class="product-gallery product-gallery-vertical d-flex">
                        <div class="product-img-large">
                            <div class="img-large-wrapper">
                                <img src="<?php echo base_url().'public/uploads/products/front/'.$product_info['image'];?>"
                                    alt="img">
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="product-details ps-lg-4">
                        ...
                        <div class="product-price-wrapper mb-4">
                            ...
                            <del class="product-price compare-price ms-2">&#8377;1799</del>
                        </div>
                        ...
                        <form class="product-form" method="post"
                            action="<?php echo base_url('shop/addCart/'.$product_info['id']) ;?>">
                                ...
                                <div class="product-variant product-variant-other">
                                    ...
                                    <ul class="variant-list list-unstyled d-flex align-items-center flex-wrap">
                                        <li class="variant-item">
                                            <input type="radio" id="s" value="S" name='size' required>
                                            <label for="s" class="variant-label">S</label>
                                        </li>
                                        <li class="variant-item">
                                            <input id="m" type="radio" value="M" name="size">
                                            <label for="m" class="variant-label">M</label>
                                        </li>
                                        <li class="variant-item">
                                            <input id="l" type="radio" value="L" name="size">
                                            <label for="l" class="variant-label">L</label>
                                        </li>
                                        <li class="variant-item">
                                            <input id="xl" type="radio" value="XL" name="size">
                                            <label for="xl" class="variant-label">XL</label>
                                        </li>
                            ...
                            <div class="misc d-flex align-items-end justify-content-between mt-4">
                                <div class="quantity d-flex align-items-center justify-content-between">
                                    <button class="qty-btn quant dec-qty">-</button>
                                    <input class="qty-input" type="number" name="qty" value="1" min="0">
                                    <button class="qty-btn quant inc-qty">+</button>
                                </div>
                            </div>
                            ...
                            <div class=" mt-4">
                                ...
                                <button type="submit" class="position-relative btn-atc loader">ADD TO
                                    CART</button>
                            </div>
        ...
        <div class="container">
            ...
            <div class="tab-content product-tab-content">
                ...
                <div id="pshipping" class="tab-pane fade">
                    <div class="desc-content">
                        <h4 class="heading_18 mb-3">Returns within the Bazzarr.com</h4>
                        <p>We have 30 days return policy from the date the item is delivered with following term and
                            conditions. Please note that you need to return the item(s) to us within 30 days from the
                            date you received the item, including any free gifts or promotions received with the goods
                            you are returning. You are purchasing the Goods as a consumer. We have selected our products
                            on the basis that they will be used for leisure use only. If you are planning to use them
                            for business purposes please make sure that you are covered by the appropriate
                            insurance.Where you decide to use the products in the course of a business, we exclude (to
                            the fullest extent permitted by law) those warranties and conditions relating to fitness for
                            a particular purpose. Our maximum liability to business users arising out of or in
                            connection with the products shall be limited to the replacement value of the product in
                            question (except in the case of death or personal injury caused by our negligence or in
                            respect of fraud). In relation to business users, we do not accept liability for the fitness
                            of goods for business purposes, nor do we accept liability for loss of use of the item nor
                            any loss over and above the cost of the item in the event of a claim for breach of warranty
                            or condition....<span><a href="<?php echo base_url('home/policy') ;?>"><strong>Read
                                        More</strong></a></span> </p>
                    </div>
                </div>
            </div>
        </div>
